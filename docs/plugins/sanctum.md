...
<div class="nm-tip">
📸 <strong>截图待制作</strong>：展示 sanctum PR 创建流程。运行 <code>bash scripts/screenshot.sh sanctum</code> 生成。
</div>
...
<div class="nm-tip">
📸 <strong>截图待制作</strong>：展示 sanctum release 的发布确认。运行 <code>bash scripts/screenshot.sh sanctum</code> 生成。
</div>
