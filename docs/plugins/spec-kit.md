...
<div class="nm-tip">
📸 <strong>截图待制作</strong>：展示 spec-kit clarify 的歧义检测结果。运行 <code>bash scripts/screenshot.sh spec-kit</code> 生成。
</div>
...
<div class="nm-tip">
📸 <strong>截图待制作</strong>：展示 spec-kit tasks 的依赖排序任务列表。运行 <code>bash scripts/screenshot.sh spec-kit</code> 生成。
</div>
